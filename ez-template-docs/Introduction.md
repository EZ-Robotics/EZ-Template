...
[Get Started](/tutorials/installation) [View on GitHub](https://github.com/EZ-Robotics/EZ-Template) [Join the Discord](https://discord.gg/EHjXBcK2Gy) [Download example project](https://github.com/EZ-Robotics/EZ-Template/releases/download/v4.0.0-beta.3/EZ-Template-Example-Project.zip)
