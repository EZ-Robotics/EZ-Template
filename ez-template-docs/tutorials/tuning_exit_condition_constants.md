...
* The fifth number is the amount of time to exit when the velocity of the robot is 0.  This only starts counting once the robot has started moving, or after 1 second if it never does  
