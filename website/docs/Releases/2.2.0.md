...
## EZ-Template 2.2.0 Release
Minor release brings in minor features and bugfixes, as well as 2 kernel updates. 

## Changelog   
See our [release page](https://github.com/EZ-Robotics/EZ-Template/releases/tag/v2.2.0) for a changelog.  
...
4) Run this command from terminal `prosv5 c fetch EZ-Template@2.2.0.zip`.  
